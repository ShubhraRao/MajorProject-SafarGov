...
class GetConDetail extends StatefulWidget {
  final String pwdid;
  final List<DocumentSnapshot> list;
  final List<DocumentSnapshot> listtravel;

  const GetConDetail({Key key, this.list, this.listtravel, this.pwdid})
      : super(key: key);
  @override
  _GetConDetailState createState() => _GetConDetailState(list);
}

class _GetConDetailState extends State<GetConDetail> {
  final List<DocumentSnapshot> list;
