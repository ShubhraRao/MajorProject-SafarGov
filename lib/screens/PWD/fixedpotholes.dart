...
import 'package:govtapp/screens/PWD/fixeddetails.dart';
import 'package:jiffy/jiffy.dart';
import 'package:pdf/widgets.dart' as pdfLib;
import 'package:path_provider/path_provider.dart';

class PWDFixedReport extends StatefulWidget {
  final String uid;
  final List<DocumentSnapshot> list;
  const PWDFixedReport(this.uid, this.list);

  @override
  _PWDFixedReportState createState() => _PWDFixedReportState(uid, list);
}

class _PWDFixedReportState extends State<PWDFixedReport> {
  final String uid;
  final List<DocumentSnapshot> list;
...
static GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  _PWDFixedReportState(this.uid, this.list);
